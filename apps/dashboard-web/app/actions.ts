  ...
  const payload = {
    ...
    metrics_json: {
      ...
      cost_model: {
        ...
        fixed_bps: numberValue(formData, "cost_bps", 5),
        commission_bps: numberValue(formData, "commission_bps", 0),
        spread_bps: numberValue(formData, "slippage_bps", 5),
        participation_rate_slippage_bps: numberValue(formData, "participation_rate_slippage_bps", 0),
        square_root_impact_coefficient: numberValue(formData, "square_root_impact_coefficient", 0),
        trade_notional: numberValue(formData, "trade_notional", 100000),
      },
      baseline_refs: listValue(formData, "baseline_refs"),
      point_in_time_controls: listValue(formData, "point_in_time_controls"),
...
export async function generateFactorSnapshotsAction(formData: FormData) {
  ...
  const payload = {
    ...
    custom_expression: stringValue(formData, "custom_expression") || null,
    provider_key: stringValue(formData, "provider_key") || null,
