...
### 2.1 Principle Synthesis (Every 6h — Evolver's Responsibility)

During each synthesis cycle (every 6 hours), Evolver performs a reflection synthesis:

```
1. Read all entries in memory/causal/ from the past 24h
2. Read all entries in memory/reflections/ from the past 24h
3. Identify recurring patterns (≥2 similar failures = pattern)
...
### 2.2 Critic Threshold Adaptation (Daily — Part of Evolution Cycle)

During the daily evolution cycle (22:00 EST), Evolver reviews Critic's performance:
...
### 2.3 Meta-Reflection (Daily — Part of Evolution Cycle)
